...
file = pd.read_excel(path, sheet_name="Energy Balance-2019", header=98)             # Already DataFrame by pandas
...
def funct_barh(title, share, colors):
    ...
    for a in ax.patches[4:5]:
        plt.text(a.get_width(), a.get_y() + 0.46,
                 ...
                 fontsize=15, fontweight='bold',
                 color='black')
    plt.savefig('Sectorial_Consump2019.png', transparent=True, dpi=300)
...
def chart(value, index, color=None):
    ...
    plt.axis('equal')
    path_savefig = "C:/Users/jerem/Desktop/Energy_Balance_V2/Energy_Balance2019/RingChart"
    plt.savefig(f'{path_savefig}/RingChart_Transport_2019.png', transparent=True, dpi=300)
