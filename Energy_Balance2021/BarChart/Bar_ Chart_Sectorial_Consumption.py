...
filename = "Seychelles Energy Balance For 2021 - ver3.xlsx"
excel_sheet_name = "Energy Balance-2021"        # nom de la feuille de calcule
position_line_header = 100                       # numéro de la ligne de l'entête du tableau
...
filename_bar_chart = 'Sectorial_Consump_2021'                              # nom du fichier de sauvegarde ; les espaces sont à éviter, mettre des "_" à la place.
filename_pie_chart = 'RingChart_Transport_2021'
