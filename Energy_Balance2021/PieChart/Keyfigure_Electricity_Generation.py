...
# ------- Données d'entrée ------- #
filename = "Seychelles Energy Balance For 2021 - ver3.xlsx"     # nom du fichier excel
excel_sheet_name = "Electricity Stat-2021"        # nom de la feuille de calcule
position_line_header = 41                       # numéro de la ligne de l'entête du tableau
...
color_elect_gene_breakdown = ['#007F7F', '#42A0A0', '#FAD335', '#A3B825']               # liste de couleur hexadécimale
